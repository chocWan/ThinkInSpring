 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://demo.choc.org/", wsdlLocation = "http://localhost:9090/ws/soap/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://demo.choc.org/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/ws/soap/hello?wsdl");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://demo.choc.org/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo.choc.org/", "HelloServiceImplPort"), HelloService.class, features);
    }
